        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">Machine Learning Test</p>
                      <p className="text-sm text-gray-500">April 14, 2025 • 09:30 PM</p>
                    </div>
                  </div>
                  <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium">
                    Test
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">ML Assignment 3</p>
                      <p className="text-sm text-gray-500">April 8, 2025 • 11:59:59 PM</p>
                    </div>
                  </div>
                  <span className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium">
                    Assignment
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  { title: 'ML Algorithms', date: 'Mar 15, 2025', subject: 'Machine Laerning' },
